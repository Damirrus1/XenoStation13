/mob/living/carbon/human/examine(mob/user)
			...
			if(U.accessories.len)
				if(skipholster)
					...
					if(accessories_visible.len)
						tie_msg += ". Attached to it is [rlowertext(english_list(accessories_visible))]"
				else tie_msg += ". Attached to it is [rlowertext(english_list(U.accessories))]"
	...
	if(wear_suit)
		...
		if(istype(wear_suit,/obj/item/clothing/suit))
			...
			if(U.accessories.len)
				tie_msg += ". Attached to it is [rlowertext(english_list(U.accessories))]"
